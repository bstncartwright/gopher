...
func TestReadGatewayNodeStatusLinesListsKnownNodes(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprint(w, `{"nodes":[{"node_id":"node-2","is_gateway":false,"capabilities":[{"kind":1,"name":"web_search"}],"last_heartbeat":"2026-01-02T03:04:06Z"},{"node_id":"gateway","is_gateway":true,"capabilities":[{"kind":2,"name":"router"}],"last_heartbeat":"2026-01-02T03:04:05Z"}]}`)
	}))
	defer server.Close()
